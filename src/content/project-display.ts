...
export const PROJECT_DISPLAY_CONFIG = {
  ...
  'regenerative-liquid-rocket-engine': { featured: false, order: 4 },
  'columbia-hybrid-rocket': { featured: false, order: 5 },
  'farout-propulsion-mentorship': { featured: false, order: 6 },
  'asteroid-orbit-determination': { featured: false, order: 7 },
